      ...
      <main className="flex-grow">
        ...
        <section className="bg-primary-900 text-white py-20 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <h1 className="text-4xl md:text-5xl font-serif font-bold mb-6">À Propos de Tommobilty</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Fondée avec une passion pour l'automobile d'exception, Tommobilty s'est imposée comme la référence 
